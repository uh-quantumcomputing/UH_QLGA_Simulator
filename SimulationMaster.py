...
BATCH = '2p_paper_set'
RUN ='trapped_emax_measured_repeat'
...
# single slit 1p
# POTENTIAL_KWARGS = {'func_list': ['pi/700.'], 'cond_list': ['((X>=2.*Lx/5.-Lx/70.) && (X<=2.*Lx/5.+Lx/70.) && (Y>=((Ly-1)/2.+Ly/70.) || Y<=((Ly-1)/2.-Ly/70.)) ) || (X<=Lx/50. || X>49.*Lx/50.)']}
# double slit 1p
...
MEASUREMENT_KWARGS = {'timesteps' : [325,975,1625], 'positions' : [255,255,255], 'widths' : [10,10,10], 'smooth' : True, 'Measured' : True}
