...
#EXP_KWARGS = {'G0' : 1., 'G1' : .1, 'G2': 1., 'MU':1.,  'scaling' : 35, "solution1" : 1, "solution2" : 5, "orientation1" : "z",  "orientation2" : "x", 'ud_shift1': 30} 
EXP_KWARGS = {'G0' : .7, 'G1' : 1., 'G2': -.7, 'MU':1.,  'scaling' : 100, "solution1" : 8, "solution2" : 7, "orientation1" : "z",  "orientation2" : "x", 'ud_shift1': 30} 
#EXP_KWARGS = {'momentums': [4.0, 0.0, 4.0, 0.0], 'shifts': [0.3, 0.7, 0.4, 0.8], 'sigmas': [0.025, 0.025, 0.25, 0.25]}
#EXP_KWARGS  = {'momentums': [4.0], 'shifts': [0.5], 'sigmas': [0.025]}
...
VIS_KWARGS = {"fps":6, "contour_percent" : [.5], "total_density" : False, "full" : True}
